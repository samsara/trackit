...
/**
 *
 * Adapted from :: https://github.com/palominolabs/metrics-new-relic
...
public final class NewRelicReporter extends ScheduledReporter {
    ...
    private void record(String name, float value) {
        //Replace all dots with / so that we can easily group metrics in NR insights.
        String newRelicName = name.replaceAll("\\.", "/");
        String fullMetricName = "Custom/" + metricNamePrefix + newRelicName;
